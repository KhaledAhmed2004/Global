  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-6 py-16 sm:py-20 md:py-24">
      ...
      <div className="flex flex-col items-center gap-8">
        <h2 className="text-center font-poppins text-4xl sm:text-5xl md:text-6xl font-medium text-black">
          Pricing List
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
          {pricingTiers.map((tier, index) => {
            ...
            return (
              <div
                key={index}
                className={`flex flex-col overflow-hidden rounded-[20px] transition-all duration-300 hover:scale-[1.02] ${
                  tier.featured
                    ? "bg-[#1d1d1d] text-white shadow-xl"
                    : "border border-[#c5c5c5] bg-white text-black"
                }`}
              >
                {/* Icon & Title */}
                <div className="flex flex-col items-center gap-6 px-8 pt-8">
                  ...
                  >
                    <span className="text-3xl sm:text-[32px] font-semibold tracking-tight">
                      {tier.price}
                    </span>
                    <span className="text-lg font-semibold">{tier.period}</span>
                  </p>
